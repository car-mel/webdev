          ...
          <div class="row">
            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Bar Graph of Activities</h5>
        ...
        <div class="col-lg-4">
          ...
          <div class="card">
            ...
            <div class="card-body pb-2" style="text-align: center;">
              ...
              <form id="announcementForm" class="container mt-4" method="post" action="announcement.php">
    <div class="form-group">
        <textarea id="contentInput" class="form-control" name="announcement" placeholder="Enter your announcement here" required rows="16"></textarea>
    </div>

    <button type="button" class="btn btn-primary" type="" onclick="postAnnouncement()">Post Announcement</button>
</form>
<script>
    function postAnnouncement() {
      alert("Announcement posted successfully!");
        ...
        // // Prepare the data
        // var data = "announcements=" + content;
